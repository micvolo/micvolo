...
export const POST: APIRoute = async ({ request, locals, redirect }) => {
  ...
  if (!(await projectExists(cloudflareEnv.DB, projectId)) || !['milestone', 'update', 'decision', 'delivery'].includes(kind) || !['public', 'private'].includes(visibility) || !validDate(occurredOn) || !title) {
